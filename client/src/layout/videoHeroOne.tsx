...
const VideoHeroOne = () => {
  ...
  return (
    <section className={`relative bg-[url(/assets/bg_1.jpg)] bg-cover bg-center flex items-center justify-center py-10`} ref={sectionRef as React.RefObject<HTMLDivElement>}>
